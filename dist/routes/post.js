...
], isAuth_1.default, post_controler_1.default.postNewReplay);
...
router.post('/likeComment', isAuth_1.default, post_controler_1.default.likeComment);
router.post('/editComment', (0, express_validator_1.body)('content', 'content is required!')
    .notEmpty(), isAuth_1.default, post_controler_1.default.editComment);
router.delete('/deleteComment', isAuth_1.default, post_controler_1.default.deleteComment);
router.get('/newPost', isAuth_1.default, post_controler_1.default.getNewPost);
router.post('/newPost', [
...
router.put('/editPost', isAuth_1.default, post_controler_1.default.editPost);
router.delete('/deletePost', isAuth_1.default, post_controler_1.default.deletePost);
